...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String testCommand = "ffmpeg -i "+ Environment.getExternalStorageDirectory().getAbsolutePath()+"/video/zsdiary.mp4"+" -vcodec wmv1 "+
            Environment.getExternalStorageDirectory().getAbsolutePath()+"/video/demo.wmv";
